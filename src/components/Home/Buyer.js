    ...
    return (
        <div className='w-3/4 mx-auto'>
            <div className='mt-32  lg:flex justify-around items-center'>
                ...
                <div
                    style={{
                        backgroundImage: `url(https://i.ibb.co/jfTXy90/bg-img1.png)`,
                    ...
                    className='pb-32 h-4/4  bg-white'>
                        ...
                        <p className='w-2/4 '>Never worry about sales <span className='text-white font-bold'>or income from</span> outboundchannels. <span className='text-white font-bold'> with chamb your store is </span>directly connected to thousands of interested in your products.</p>
