    ...
    return (
        <div className=''>
            <div className='flex justify-center '>
                <div className='bg-red-500 ' onMouseEnter={e => {
                    ...
                    <div className={`bg-white w-[450px] duration-1000 rounded-lg  px-12 mt-4 ml-[6px] mb-[-400px] absolute ${hoverDone && 'translate-y-20'}`} >
